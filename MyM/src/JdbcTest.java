...
public class JdbcTest {
    ...
    static void test_jdbc_connect() {
     String DB_URL = "jdbc:mysql://songc.c8w2ftnpjfm4.us-east-2.rds.amazonaws.com:3306"; // DB이름인 book_ex를 적절히 변경 
     String DB_USER = "songc";  // DB의 userid와 pwd를 알맞게 변경 
     String DB_PASSWORD = "alstjr9200"; 
